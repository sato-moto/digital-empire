...
- **図解内の全てのラベル・見出し・本文テキストは日本語のみで描画すること。英語・ローマ字・英単語（"AI""PDF""OK"等の一般定着語は例外として許容）を独立したラベルや見出しとして使用すること、または日本語テキストの翻訳として並記することは禁止。テーマが英単語学習等であっても、図解ラベル自体は日本語で統一する**
